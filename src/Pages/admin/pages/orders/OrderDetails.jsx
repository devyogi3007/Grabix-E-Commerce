        ...
        <div class="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
          <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
            <div class="flex flex-col justify-start items-start  bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
              <p class="text-lg md:text-xl text-gray-800 font-semibold leading-6 xl:leading-5 text-gray-800">
                Customer’s Cart
              </p>
            ...
            <div class="flex justify-center flex-col md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
              <div class="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50  space-y-6">
                <h3 class="text-xl text-gray-800 font-semibold leading-5 text-gray-800">
                  Summary
                </h3>
                <div class="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                  <div class="flex justify-between w-full">
                    <p class="text-base text-gray-800 leading-4 text-gray-800">
                      Subtotal
                    </p>
                ...
                <div class="flex justify-between items-center w-full">
                  <p class="text-base text-gray-800 font-semibold leading-4 text-gray-800">
                    Total
                  </p>
                ...
                <div class="flex justify-between items-start w-full">
                  <div class="flex justify-center items-center space-x-4">
                    ...
                    <div class="flex flex-col justify-start items-center">
                      <p class="text-lg leading-6 text-gray-800 font-semibold text-gray-800">
                        DPD Delivery
                        <br />
                  ...
                  <p class="text-lg font-semibold leading-6 text-gray-800 text-gray-800">
                    $8.00
                  </p>
                  {/* <p className=''> Store : Apple </p> */}
                </div>
              ...
              <div class="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                <div class="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-center md:items-start">
                  <div class="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-8">
                    <p class="text-base text-gray-800 font-semibold leading-4 text-center md:text-left text-gray-800">
                      Shipping Address
                    </p>
